...
export default function LumiApp() {
  ...
  const [tasks, setTasks] = useState<Task[]>([
    { id: "1", title: "Responder e-mails importantes", completed: false, priority: "high" },
    { id: "2", title: "Fazer compras no mercado", completed: false, priority: "medium" },
    { id: "3", title: "Ligar para o dentista", completed: false, priority: "urgent" },
    { id: "4", title: "Organizar mesa de trabalho", completed: false, priority: "low" },
  ]);
  ...
  const [achievements, setAchievements] = useState<Achievement[]>([
    { id: "1", title: "Primeiro Passo", description: "Complete sua primeira tarefa", icon: "🎯", unlocked: true },
    { id: "2", title: "Foco Total", description: "Complete 5 sessões de foco", icon: "🔥", unlocked: true, progress: 5, total: 5 },
    { id: "3", title: "Sequência de 7", description: "Mantenha uma sequência de 7 dias", icon: "⭐", unlocked: false, progress: 3, total: 7 },
    { id: "4", title: "Mestre da Produtividade", description: "Complete 50 tarefas", icon: "🏆", unlocked: false, progress: 12, total: 50 },
    { id: "5", title: "Madrugador", description: "Complete uma tarefa antes das 8h", icon: "🌅", unlocked: false },
    { id: "6", title: "Organizador", description: "Organize 20 tarefas em categorias", icon: "📋", unlocked: false, progress: 8, total: 20 },
  ]);
  ...
  const toggleTask = (id: string) => {
    setTasks(tasks.map(task => {
      if (task.id === id && !task.completed) {
        // Incrementar stats quando completar tarefa
        setStats(prev => ({
          ...prev,
          tasksCompleted: prev.tasksCompleted + 1,
          totalPoints: prev.totalPoints + 20,
          level: Math.floor((prev.totalPoints + 20) / 100) + 1
        }));
  ...
  if (currentView === "home") {
    return (
      <div className={`min-h-screen ${getThemeClasses()} p-4 sm:p-6 transition-all duration-300`}>
  ...
  if (currentView === "gamification") {
    ...
    return (
      <div className={`min-h-screen ${getThemeClasses()} p-4 sm:p-6`}>
        <div className="max-w-4xl mx-auto">
  ...
  if (currentView === "focus") {
    ...
    return (
      <div className={`min-h-screen ${getThemeClasses()} p-4 sm:p-6 flex items-center justify-center`}>
  ...
  if (currentView === "emergency") {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-500 to-pink-500 p-4 sm:p-6 flex items-center justify-center">
        <div className="max-w-2xl w-full">
          <button
            onClick={() => setCurrentView("home")}
                ...
                captures.map((capture) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-500">
                      {capture.timestamp.toLocaleString("pt-BR")}
                    </p>
                  </div>
                ))
              )}
